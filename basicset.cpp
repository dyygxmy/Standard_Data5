...
//        ui->stackedWidget->setCurrentIndex(1);
    ...
    {
        ui->label_29->show();
        ui->lineEdit_AndonServerIp->show();
        ui->label_31->hide();
        ui->lineEdit_port->hide();
    }
    else if(factory == "BYDSZ" ||factory == "BYDXA" ||factory == "Benz" ||factory == "Ningbo")
    {
        ui->label_29->hide();
...
void BasicSet::on_pushButton_38_clicked()
{
    if(SaveWhat == "Controller")
    {
        ...
        else if(ui->comboBox->currentText()=="SB356_XML")
            configIniRead->setValue("baseinfo/ControlType_1","SB356_XML");
        else if(ui->comboBox->currentText()=="Bosch_Nexo_OP")
            configIniRead->setValue("baseinfo/ControlType_1","Nexo_OP");
        else if(ui->comboBox->currentText()=="APEX_OP")
            configIniRead->setValue("baseinfo/ControlType_1","APEX_OP");
        else if(ui->comboBox->currentText()=="Desoutter")
            configIniRead->setValue("baseinfo/ControlType_1","Desoutter");
        ...
        else if(ui->comboBox_2->currentText()=="SB356_XML")
            configIniRead->setValue("baseinfo/ControlType_2","SB356_XML");
        else if(ui->comboBox_2->currentText()=="Bosch_Nexo_OP")
            configIniRead->setValue("baseinfo/ControlType_2","Nexo_OP");
        else if(ui->comboBox_2->currentText()=="APEX_OP")
            configIniRead->setValue("baseinfo/ControlType_2","APEX_OP");
        else if(ui->comboBox_2->currentText()=="Desoutter")
            configIniRead->setValue("baseinfo/ControlType_2","Desoutter");


        if(ui->comboBox_3->currentIndex()==0)
            configIniRead->setValue("baseinfo/factory","SVW3");
        else if(ui->comboBox_3->currentIndex()==1)
            configIniRead->setValue("baseinfo/factory","SVW2");
        else if(ui->comboBox_3->currentIndex()==2)
            configIniRead->setValue("baseinfo/factory","Ningbo");
        else if(ui->comboBox_3->currentIndex()==3)
            configIniRead->setValue("baseinfo/factory","BYDSZ");
        else if(ui->comboBox_3->currentIndex()==4)
            configIniRead->setValue("baseinfo/factory","BYDXA");
        else if(ui->comboBox_3->currentIndex()==5)
            configIniRead->setValue("baseinfo/factory","Benz");
        else if(ui->comboBox_3->currentIndex()==6)
            configIniRead->setValue("baseinfo/factory","GM");
        else if(ui->comboBox_3->currentIndex()==7)
            configIniRead->setValue("baseinfo/factory","Haima");
        else if(ui->comboBox_3->currentIndex()==8)
            configIniRead->setValue("baseinfo/factory","Dongfeng");
        else if(ui->comboBox_3->currentIndex()==9)
            configIniRead->setValue("baseinfo/factory","BAIC");
        else if(ui->comboBox_3->currentIndex()==10)
            configIniRead->setValue("baseinfo/factory","GZBAIC");        
        else if(ui->comboBox_3->currentIndex()==11)
            configIniRead->setValue("baseinfo/factory","NOVAT");
        else if(ui->comboBox_3->currentIndex()==12)
            configIniRead->setValue("baseinfo/factory","AQCHERY");
        else if(ui->comboBox_3->currentIndex()==13)
            configIniRead->setValue("baseinfo/factory","KFCHERY");
...
void BasicSet::setConfigValue351(QString controller1_Ip, QString controller2_Ip)
{
    ...
    ControllerList<<"OFF"<<"Bosch_CS351"<<"Bosch_Nexo"<<"Bosch_SB356"<<"Bosch_SB356_PLC"<<"Apex_Cleco"<<"Atlas_PF_D"
                 <<"Atlas_PF_C"<<"Atlas_PM_M"<<"Atlas_PM"<<"Atlas_PM600"<<"Ingersoll_Rand"<<"GWK"<<"PF_XML"<<"PF_232"
                <<"SB356_XML"<<"Bosch_Nexo_OP"<<"APEX_OP"<<"Desoutter";
    ...
    else if(configIniRead->value("baseinfo/ControlType_1").toString()=="SB356_XML")
        ui->comboBox->setCurrentIndex(15);    
    else if(configIniRead->value("baseinfo/ControlType_1").toString()=="Nexo_OP")
        ui->comboBox->setCurrentIndex(16);
    else if(configIniRead->value("baseinfo/ControlType_1").toString()=="APEX_OP")
        ui->comboBox->setCurrentIndex(17);
    else if(configIniRead->value("baseinfo/ControlType_1").toString()=="Desoutter")
    ...
    else if(configIniRead->value("baseinfo/ControlType_2").toString()=="SB356_XML")
        ui->comboBox->setCurrentIndex(15);    
    else if(configIniRead->value("baseinfo/ControlType_2").toString()=="Nexo_OP")
        ui->comboBox->setCurrentIndex(16);
    else if(configIniRead->value("baseinfo/ControlType_2").toString()=="APEX_OP")
        ui->comboBox->setCurrentIndex(17);
    else if(configIniRead->value("baseinfo/ControlType_2").toString()=="Desoutter")
        ui->comboBox->setCurrentIndex(18);

    QStringList FactoryList;
    FactoryList<<tr("大众三厂")<<tr("大众二厂")<<tr("宁波大众")<<tr("深圳比亚迪")<<tr("西安比亚迪")<<tr("福建奔驰")<<tr("上汽通用")<<tr("郑州海马")
              <<tr("东风柳汽")<<tr("株洲北汽")<<tr("广州北汽")<<tr("天际汽车")<<tr("安庆振宜")<<tr("开封奇瑞");
    ui->comboBox_3->addItems(FactoryList);
    if(configIniRead->value("baseinfo/factory").toString()=="SVW3"||configIniRead->value("baseinfo/factory").toString()=="")
        ui->comboBox_3->setCurrentIndex(0);
    else if(configIniRead->value("baseinfo/factory").toString()=="SVW2")
        ui->comboBox_3->setCurrentIndex(1);
    else if(configIniRead->value("baseinfo/factory").toString()=="Ningbo")
        ui->comboBox_3->setCurrentIndex(2);
    else if(configIniRead->value("baseinfo/factory").toString()=="BYDSZ")
        ui->comboBox_3->setCurrentIndex(3);
    else if(configIniRead->value("baseinfo/factory").toString()=="BYDXA")
        ui->comboBox_3->setCurrentIndex(4);
    else if(configIniRead->value("baseinfo/factory").toString()=="Benz")
        ui->comboBox_3->setCurrentIndex(5);
    else if(configIniRead->value("baseinfo/factory").toString()=="GM")
        ui->comboBox_3->setCurrentIndex(6);
    else if(configIniRead->value("baseinfo/factory").toString()=="Haima")
        ui->comboBox_3->setCurrentIndex(7);
    else if(configIniRead->value("baseinfo/factory").toString()=="Dongfeng")
        ui->comboBox_3->setCurrentIndex(8);
    else if(configIniRead->value("baseinfo/factory").toString()=="BAIC")
        ui->comboBox_3->setCurrentIndex(9);
    else if (configIniRead->value("baseinfo/factory").toString()=="GZBAIC")
        ui->comboBox_3->setCurrentIndex(10);    
    else if (configIniRead->value("baseinfo/factory").toString()=="NOVAT")
        ui->comboBox_3->setCurrentIndex(11);
    else if (configIniRead->value("baseinfo/factory").toString()=="AQCHERY")
        ui->comboBox_3->setCurrentIndex(12);
    else if (configIniRead->value("baseinfo/factory").toString()=="KFCHERY")
        ui->comboBox_3->setCurrentIndex(13);
    delete configIniRead;
}
...
void BasicSet::setSerialOrRfidMode(QString tmp1, QString tmp2, QString tmp3)
{
    if(isRFID)
    {
        ...
        if(factory == "Dongfeng")
        {
            ui->label_26->setText("通信 IP：");
            ui->label_24->setText(tr("通信端口号："));
        }
    }
    else
    {
...
void BasicSet::on_pushButton_truncateQueue_clicked()
{
    emit sendTruncateQueue();
}

void BasicSet::receiveResult(bool tmp)
{
    if(tmp)
        ui->label_5->setText(tr("成功!"));
    else
        ui->label_5->setText(tr("失败!"));
}

void BasicSet::receiveQueueResult(bool tmp)
{
    if(tmp)
        ui->label_queue->setText(tr("成功!"));
    else
        ui->label_queue->setText(tr("失败!"));
}
