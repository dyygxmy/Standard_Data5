#ifndef TIGHTEN_OP_NET_CH2_H
#define TIGHTEN_OP_NET_CH2_H
...
#include <QtNetwork>
#include <QDateTime>
class TightenOpNetCh2 : public QObject
{
    Q_OBJECT
public:
    explicit TightenOpNetCh2(QObject *parent = 0);
...
private slots:
    void tightenStartCh2();
    void disConnectDO();
    void newConnects();
    void ctlNexoHandle();
    void revNexoData();
    void timerFunc5000ms();
    void sendReadOperateCh2(bool,int);
